          ...
          <div className="prose prose-lg max-w-none space-y-6">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                By accessing and using the myHometown Utah website and services,
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>
                  ...
                  classes or subscribing to newsletters
                </li>
                <li>
                ...
                <li>
                  Use our services for lawful purposes only and in a manner that
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    result in removal from the program to make space for others
                    on waiting lists.
                  </p>
                </div>
                <div>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                approval processes as required by individual CRCs and programs.
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>
                  Report any incidents or concerns to appropriate staff members
                </li>
                <li>
                  Commit to scheduled volunteer times and provide advance notice
                  of unavailability
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                images, is owned by myHometown Utah or our content suppliers and
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                use of our services or participation in CRC programs. This
                includes, but is not limited to, damages for loss of data, loss
                of income, or personal injury.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                By continuing to use our services after changes are posted, you
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Utah, United States. Any disputes arising from these terms shall
                be resolved in the courts of Utah.
              </p>
            </section>
