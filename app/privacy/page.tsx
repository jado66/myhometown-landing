            ...
            <CardContent className="prose prose-lg max-w-none space-y-6">
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  myHometown Utah is committed to protecting your privacy. We
                  only collect information that you voluntarily provide to us
                  through:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    ...
                    to our newsletter, we collect your email address and
                    selected city preference to send you relevant community
                    updates.
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    To improve our programs and services based on community
                    needs
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  forms. You can disable cookies in your browser settings if you
                  prefer.
                </p>
              </section>
